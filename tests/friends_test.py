...
class TestFriends(unittest.TestCase):
  ...
  def test_add_friend(self):
    add_friend(self.person4, "Scrappy-Doo")
    self.assertEqual(4, len(self.person4["friends"]))

  def test_add_friend(self):
    add_friend(self.person5, "Zhu")
    self.assertEqual(1, len(self.person5["friends"]))
  ...
  def test_remove_friend(self):
    ...
    self.assertEqual(0, len(self.person2["friends"]))
